...
!function(e) {
  ...
  function o(t, i) {
    ...
    if (null === t || t.length < 1)
      return[];
    for (n = t.split(i), a = 0, r = n.length; r > a; a += 1)
      n[a] = e.trim(n[a]);
    return n
  }
  function s(e) {
  ...
  function S(e, i, n, a) {
    ...
    for (; ; ) {
      ...
      if (o = e.substring(0, s), e = e.substring(s + h.length), o.length > 0 && (o = a.createSearchChoice.call(this, o, i), o !== t && null !== o && a.id(o) !== t && null !== a.id(o))) {
        for (u = !1, l = 0, d = i.length; d > l; l++)
          if (r(a.id(o), a.id(i[l]))) {
            u = !0;
            break
          }
        u || n(o)
    ...
    P = e(document), D = function() {
      ...
      O.x = e.pageX, O.y = e.pageY
        ...
        if (App.isIE8() || App.isIE9())
          var y = this.container.outerWidth(!1);
        else
        ...
        if ((i === !0 || !g || !r(p, g)) && (e.data(this.container, "select2-last-term", p), i === !0 || this.showSearchInput !== !1 && this.opened())) {
          ...
          if (f >= 1 && (o = this.data(), e.isArray(o) && o.length >= f && T(c.formatSelectionTooBig, "formatSelectionTooBig")))
            return a("<li class='select2-selection-limit'>" + c.formatSelectionTooBig(f) + "</li>"), void 0;
          if (d.val().length < c.minimumInputLength)
            return T(c.formatInputTooShort, "formatInputTooShort") ? a("<li class='select2-no-results'>" + c.formatInputTooShort(d.val(), c.minimumInputLength) + "</li>") : a(""), i && this.showSearch && this.showSearch(!0), void 0;
          if (c.maximumInputLength && d.val().length > c.maximumInputLength)
            return T(c.formatInputTooLong, "formatInputTooLong") ? a("<li class='select2-no-results'>" + c.formatInputTooLong(d.val(), c.maximumInputLength) + "</li>") : a(""), void 0;
          c.formatSearching && 0 === this.findHighlightableChoices().length && a("<li class='select2-searching'>" + c.formatSearching() + "</li>"), d.addClass("select2-active"), this.removeHighlight(), s = this.tokenize(), s != t && null != s && d.val(s), this.resultsPage = 1, c.query({element: c.element, term: d.val(), page: this.resultsPage, context: null, matcher: c.matcher, callback: this.bind(function(o) {
              ...
              if (l == this.queryCount) {
                ...
                }).length && o.results.unshift(s)), 0 === o.results.length && T(c.formatNoMatches, "formatNoMatches"))
                  return a("<li class='select2-no-results'>" + c.formatNoMatches(d.val()) + "</li>"), void 0;
          ...
          if ("copy" === this.opts.width || "resolve" === this.opts.width) {
            if (i = this.opts.element.attr("style"), i !== t)
              for (n = i.split(";"), r = 0, o = n.length; o > r; r += 1)
                if (a = n[r].replace(/\s/g, "").match(/[^-]width:(([-+]?([0-9]*\.)?[0-9]+)(px|em|ex|%|in|cm|mm|pt|pc))/i), null !== a && a.length >= 1)
                  return a[1];
        ...
        this.opts.minimumResultsForSearch < 0 ? this.showSearch(!1) : this.showSearch(!0), this.selection = t = i.find(".select2-choice"), this.focusser = i.find(".select2-focusser"), this.focusser.attr("id", "s2id_autogen" + D()), e("label[for='" + this.opts.element.attr("id") + "']").attr("for", this.focusser.attr("id")), this.focusser.attr("tabindex", this.elementTabIndex), this.search.on("keydown", this.bind(function(e) {
          ...
          if (this.isInterfaceEnabled() && e.which !== A.TAB && !A.isControl(e) && !A.isFunctionKey(e) && e.which !== A.ESC) {
            if (this.opts.openOnEnter === !1 && e.which === A.ENTER)
              return f(e), void 0;
        ...
        if (e = arguments[0], arguments.length > 1 && (i = arguments[1]), this.select)
          ...
          }), this.updateSelection(n), this.setPlaceholder(), i && this.triggerChange({added: n, removed: r});
        else {
          if (!e && 0 !== e)
        ...
        return"select" === t.element.get(0).tagName.toLowerCase() ? t.initSelection = function(e, t) {
          ...
          t.query({matcher: function(i, n, o) {
              ...
              for (var e = [], i = 0; i < a.length; i++)
                for (var o = a[i], l = 0; l < s.length; l++) {
                  var d = s[l];
                  if (r(o, t.id(d))) {
        ...
        this.selection.on("click", ".select2-search-choice:not(.select2-locked)", function() {
          ...
          if (this.isInterfaceEnabled()) {
            ...
            if ((e.which === A.BACKSPACE && 1 == this.keydowns || e.which == A.LEFT) && 0 == r.offset && !r.length)
        ...
        if (t = e.data("select2-data")) {
          for (; (i = n(this.id(t), a)) >= 0; )
            a.splice(i, 1), this.setVal(a), this.select && this.postprocessResults();
        ...
        for (var t = t.slice(0), e = e.slice(0), i = 0; i < t.length; i++)
          for (var n = 0; n < e.length; n++)
            r(this.opts.id(t[i]), this.opts.id(e[n])) && (t.splice(i, 1), i--, e.splice(n, 1), n--);
        return{added: t, removed: e}
      }, val: function(i, n) {
        var a, r = this;
        if (0 === arguments.length)
          return this.getVal();
        if (a = this.data(), a.length || (a = []), !i && 0 !== i)
          return this.opts.element.val(""), this.updateSelection([]), this.clearSearch(), n && this.triggerChange({added: this.data(), removed: a}), void 0;
        if (this.setVal(i), this.select)
          this.opts.initSelection(this.select, this.bind(this.updateSelection)), n && this.triggerChange(this.buildChangeDetails(a, this.data()));
        else {
          if (this.opts.initSelection === t)
      ...
      return this.each(function() {
        if (0 === l.length || "object" == typeof l[0])
          i = 0 === l.length ? {} : e.extend({}, l[0]), i.element = e(this), "select" === i.element.get(0).tagName.toLowerCase() ? s = i.element.prop("multiple") : (s = i.multiple || !1, "tags"in i && (i.multiple = s = !0)), a = s ? new N : new R, a.init(i);
        else {
          if ("string" != typeof l[0])
            throw"Invalid arguments to select2 plugin: " + l;
          if (n(l[0], d) < 0)
            throw"Unknown method: " + l[0];
          if (o = t, a = e(this).data("select2"), a === t)
            return;
          if (r = l[0], "container" === r ? o = a.container : "dropdown" === r ? o = a.dropdown : (u[r] && (r = u[r]), o = a[r].apply(a, l.slice(1))), n(l[0], h) >= 0 || n(l[0], c) && 1 == l.length)
            return!1
        }
      }), o === t ? this : o
