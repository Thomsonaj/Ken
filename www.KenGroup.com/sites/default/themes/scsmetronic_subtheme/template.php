 ...
 * @see html.tpl.php
 */
function scsmetronic_subtheme_preprocess_html(&$variables) {
...
function scsmetronic_subtheme_views_data_export_feed_icon($variables) {
...
function scsmetronic_subtheme_check_below($below) {
  $exists = FALSE;
...
function scsmetronic_subtheme_links__system_user_menu($variables) {
...
function scsmetronic_subtheme_theme() {
  $items = array();
  ...
  $items['view_invoice_details_form'] = array(
    'render element' => 'form',
    'path' => drupal_get_path('theme', 'scsmetronic_subtheme') . '/templates/views',
    'template' => 'view-invoice-order-details-form',
  );
   $items['view_invoice_totals_form'] = array(
    'render element' => 'form',
    'path' => drupal_get_path('theme', 'scsmetronic_subtheme') . '/templates/views',
    'template' => 'view-invoice-totals-form',
  );
  return $items;
}
...
function scsmetronic_subtheme_login_user_image($user) {
 ...
 */
function scsmetronic_subtheme_username (&$variables) {
